        ...
        <div class="row">
                ...
                <label>
                    <div class="checkbox_register icheck">
                        <label data-toggle="modal" data-target="#termsModal">
                            ...
                            <a href="#" data-toggle="modal" data-target="#termsModal" :class="{ 'text-danger': form.errors.has('terms') }"> Terms and Conditions</a>
                        </label>
                    </div>
                </label>
            </div>
            <div class="col-xs-4 col-xs-push-1">
                <button type="submit" class="btn btn-primary btn-block btn-flat" :disabled="form.errors.any()">
                    <i v-if="form.submitting" class="fa fa-refresh fa-spin"></i>Register</button>
            </div>
        </div>
